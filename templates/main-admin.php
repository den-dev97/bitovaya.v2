<main class="main">
    <div>
        ...
        <?php if($orders): ?>
        <div class="columns p-3 m-3 is-centered box is-multiline">
        ...
        <?php endif ?>
        <div class="columns p-3 m-3 box is-multiline">
            <p class="column is-12 has-text-centered has-text-danger is-uppercase has-text-weight-semibold">
                        ...
                        <div class="field">
                            <div class="control">
                                ...
                                <table id="preview" class="table is-bordered is-fullwidth mt-3" style="display:none">
                                    <tr>
                                        <td class="img-table" id="preview_img"></td>
        ...
        <div class="columns mt-3 is-centered">
            <div class="column is-12">
                <table class=" table is-fullwidth is-bordered has-text-centered table-orders" id="table_products" style="display:none">
                    <thead>
                        <tr>
                            <th>Фото</th>
                            <th>Наименование</th>
